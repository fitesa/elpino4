...
var style_EvolucinIndicedeVegetacin_4 = function(feature, resolution){
    ...
    if (value >= -0.482538 && value <= -0.394759) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.394759 && value <= -0.306979) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.306979 && value <= -0.219200) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.219200 && value <= -0.131421) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.131421 && value <= -0.043641) {
            style = [ new ol.style.Style({
