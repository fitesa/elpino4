...
var style_IndicedeVegetacin_5 = function(feature, resolution){
    ...
    if (value >= 0.440720 && value <= 0.497693) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.497693 && value <= 0.554666) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.554666 && value <= 0.611639) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.611639 && value <= 0.668612) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.668612 && value <= 0.725586) {
            style = [ new ol.style.Style({
