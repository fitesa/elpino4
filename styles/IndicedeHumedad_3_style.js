...
var style_IndicedeHumedad_3 = function(feature, resolution){
    ...
    if (value >= -0.003768 && value <= 0.061033) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.061033 && value <= 0.125834) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.125834 && value <= 0.190635) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.190635 && value <= 0.255436) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.255436 && value <= 0.320237) {
            style = [ new ol.style.Style({
