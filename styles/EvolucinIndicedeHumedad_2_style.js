...
var style_EvolucinIndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.482882 && value <= -0.392090) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.392090 && value <= -0.301298) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.301298 && value <= -0.210505) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.210505 && value <= -0.119713) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.119713 && value <= -0.028921) {
            style = [ new ol.style.Style({
